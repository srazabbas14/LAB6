		...
		//Register JDBC driver
		 Class.forName("com.mysql.jdbc.Driver");
	       ...
	       /*Statement statement = connection.createStatement();
	        ...
	        ResultSet appetizers = statement1.executeQuery("SELECT * FROM item WHERE course_no=1");
	        
	        Statement statement2 = connection.createStatement();
	        ResultSet soups = statement2.executeQuery("SELECT * FROM item WHERE course_no=2");
	        
	        Statement statement3 = connection.createStatement();
	        ResultSet dish = statement3.executeQuery("SELECT * FROM item WHERE course_no=3");
	        
	        Statement statement4 = connection.createStatement();
	        ResultSet side = statement4.executeQuery("SELECT * FROM item WHERE course_no=4");*/
	       ...
	       //for inserting user data in database
	       String insert_user="Insert into users(user_name,user_address,user_phone) values(?,?,?)";
